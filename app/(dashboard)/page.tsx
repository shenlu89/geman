    ...
    <>
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Welcome to your dashboard. You can configure the LLM API Key proxy and load balancing.
        </p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <p className="text-sm text-gray-500 mt-1">Set up your LLM API keys and endpoints</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              <h3 className="font-medium text-gray-900">Load Balancing</h3>
              <p className="text-sm text-gray-500 mt-1">Configure request distribution settings</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              <h3 className="font-medium text-gray-900">Monitor Usage</h3>
              <p className="text-sm text-gray-500 mt-1">View API usage statistics and logs</p>
            </div>
            <div className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
              <h3 className="font-medium text-gray-900">Manage Tokens</h3>
              <p className="text-sm text-gray-500 mt-1">Configure allowed tokens and access control</p>
            </div>
          </div>
        </div>
      </div>
